...
<?php
$messagesQ = $db->query("
SELECT *, p.nome as nomeprojeto FROM 
         atividadescidade a
    join tipoatividade b on (a.idtipoatividadea = b.id)
    join projetos p on (p.id = b.idprojeto)

 WHERE idcidade = ? and status = ? ORDER BY a.id DESC",array($user->data()->idcidade,'feedback'));
...
<!-- 					<a target="_blank" href="https://www.totoprayogo.com/#">New Web Design</a> -->
					<a href="#" class="float-right"> <?=utf8_encode($m->nomeprojeto)?> / <?=$dataEvento?></a>
