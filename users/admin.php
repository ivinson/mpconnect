...
<?php require_once $abs_us_root.$us_url_root.'users/includes/header_adm.php'; ?>
<?php require_once $abs_us_root.$us_url_root.'users/includes/navigation_adm.php'; ?>
...
<h1 class="text-center">DashBoard MPC BRASIL <?=$user_spice_ver?></h1>


<div class="row"> <!-- row for Users, Permissions, Pages, Email settings panels -->
	<h2>Paineis Administrativos</h2>
	<!-- Users Panel -->
	...
	<span class="pull-left"><a href="admin_users.php">Configurar</a></span>
	...
	<div class="col-xs-6 col-md-3">
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Niveis de Permissão</strong></div>
	<div class="panel-body text-center"><div class="huge"> <i class='fa fa-lock fa-1x'></i> <?=$level_count?></div></div>
	<div class="panel-footer">
	<span class="pull-left"><a href="admin_permissions.php">Configurar</a></span>
	<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
	<div class="clearfix"></div>
	</div> <!-- /panel-footer -->
	</div><!-- /panel -->
	...
	<div class="panel-footer">
	<span class="pull-left"><a href="admin_pages.php">Configurar</a></span>
	<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
	<div class="clearfix"></div>
	</div> <!-- /panel-footer -->
	</div><!-- /panel -->
	...
	<div class="col-xs-6 col-md-3">
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Configurações de email</strong></div>
	<div class="panel-body text-center"><div class="huge"> <i class='fa fa-paper-plane fa-1x'></i> 9</div></div>
	<div class="panel-footer">
	<span class="pull-left"><a href='email_settings.php'>Configurar</a></span>
	<span class="pull-right"><i class='fa fa-arrow-circle-right'></i></span>
	<div class="clearfix"></div>
	</div> <!-- /panel-footer -->
	</div> <!-- /panel -->
...
<div class="row "> <!-- rows for Info Panels -->
	...
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Todos Usuarios</strong> <span class="small">(que logaram)</span></div>
	...
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Todos os Visitantes</strong> <span class="small">(que não se logaram)</span></div>
	<div class="panel-body">
	<?php  if($settings->track_guest == 1){ ?>
	<?="Nos últimos 30 minutos, contamos ".count_users()." visitantes unicos<br>";?>
	<?php }else{ ?>
	...
	<div class="col-xs-12 col-md-6">
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Usuarios Logados</strong> <span class="small">(ultimas 24h)</span></div>
	<div class="panel-body">
	<div class="uvistable table-responsive">
	<table class="table">
	<?php if($settings->track_guest == 1){ ?>
	<thead><tr><th>Usuario</th><th>IP</th><th>Ultimas atividades</th></tr></thead>
	<tbody>
	...
	<div class="panel panel-default">
	<div class="panel-heading"><strong>Eventos Auditados</strong><span align="right" class="small"><a href="tomfoolery.php"> (Ver Logs)</a></span></div>
