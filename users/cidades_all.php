...
select 
   ...
   from cidades
        left outer join regioes on (cidades.idregiao = regioes.id)
...
?>
    ...
    <div class="row clearfix">
        ...
        <a href="cidades_all.php">
          <div class="info-box bg-teal hover-expand-effect">
            ...
            <div class="content">
              ...
              <div class="number count-to" data-from="0" data-to="125" data-speed="15" data-fresh-interval="20"> <?=$total_cidades_tot?></div>
            </div>
          </div>
        </a>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="cidades_all.php?filter=1">
          <div class="info-box bg-light-green hover-expand-effect">
            ...
            <div class="content">
              ...
              <div class="number count-to" data-from="0" data-to="125" data-speed="15" data-fresh-interval="20"><?=$total_cidades[0]->total ?></div>
            </div>
          </div>
        </a>
      ...
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="cidades_all.php?filter=2">
          <div class="info-box bg-light-green hover-expand-effect">
            <div class="icon">
              <i class="material-icons">location_on</i>
            </div>
            <div class="content">
              ...
              <div class="number count-to" data-from="0" data-to="257" data-speed="1000" data-fresh-interval="20"><?=$total_cidades[1]->total ?></div>
            </div>
          </div>
        </a>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="cidades_all.php?filter=3">
          <div class="info-box bg-light-green hover-expand-effect">
            <div class="icon">
              <i class="material-icons">location_on</i>
            </div>
            <div class="content">
              ...
              <div class="number count-to" data-from="0" data-to="243" data-speed="1000" data-fresh-interval="20"><?=$total_cidades[2]->total ?></div>
            </div>
          </div>
        </a>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="cidades_all.php?filter=4">
          <div class="info-box bg-light-green hover-expand-effect">
            <div class="icon">
              <i class="material-icons">location_on</i>
            </div>
            <div class="content">
              ...
              <div class="number count-to" data-from="0" data-to="1225" data-speed="1000" data-fresh-interval="20"><?=$total_cidades[3]->total ?></div>
            </div>
          </div>
        </a>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        <a href="cidades_all.php?filter=5">
          <div class="info-box bg-light-green hover-expand-effect">
            <div class="icon">
              <i class="material-icons">location_on</i>
            </div>
            <div class="content">
              ...
              <div class="number count-to" data-from="0" data-to="1225" data-speed="1000" data-fresh-interval="20"><?=$total_cidades[4]->total ?></div>
            </div>
          </div>
        </a>
      </div>
...
<!--       <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <a href="cidade.php">
          <div class="info-box bg-cyan hover-expand-effect">
            ...
            <div class="content">
              <div class="text"></div>
              <div class="number count-to" data-from="0" data-to="1225" data-speed="1000" data-fresh-interval="20">INCLUIR NOVA CIDADE</div>
            </div>
          </div>
        </a>
      </div>       -->
