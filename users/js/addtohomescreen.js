...
ath.intl = {
	...
	pt_br: {
		...
		android: 'Pedimos que clique no menu e depois <strong>Adicionar a tela inicial</strong>. <small>Para acessar essa funcionalidade, pressione o botão tocando no ícone do menu superior direito<span class="ath-action-icon">icon</span>.</small>',
	},
