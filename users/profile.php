...
if(isset($_GET['id']))
	...
	if($thisUserID == $userID)
		{
		$editbio = ' <small><a href="edit_profile.php">Editar minha bio </a></small>';
		}
	else
		{
		$editbio = '';
	...
	$ususername = " Biografia de " . ucfirst($thatUser->fname . " " . $thatUser->lname);
	...
	$useravatar = '';
	$editbio = ' <small><a href="/">Home</a></small>';
	}
?>
   <div id="page-wrapper">
					...
					<div class="row">
						...
						<h3><?php echo $ususername;?></h3>
							<h2><?php echo $usbio.$editbio;?></h2>
										...
										<a class="btn btn-success" href="view_all_users.php" role="button">Visualizar todos os contatos</a>
