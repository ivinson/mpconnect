...
if(!empty($_POST['send_message'])){
  ...
  $thread = array(
    ...
    'priority' => Input::get('msg_priority'),
  ...
  Redirect::to('create_message.php?msg=<h1>Mensagem+Enviada!</h1>');
}
          ...
          <div class="col-xs-12 col-md-10">
            ...
            <form name="create_message" action="create_message.php?id=<?=$id?>" method="post">
              ...
              <div align="left">
                ...
                <select name="msg_priority" id="msg_priority"> 
                    <option value="0" > Urgente </option>
                    <option value="1"> Recomendação </option>
                    <option value="2"> Novidade/Sugestão </option>
                </select>

                <textarea rows="20" cols="20"  id="mytextarea" name="msg_body" ></textarea></div>
            ...
            <?php }else{ ?>
              <form class="" name="search" action="create_message.php" method="post">
                <label for="system-search">Para quem</label>
                <div class="input-group">
                  <input type="text" class="form-control" name="input" id="system-search" value="" placeholder="Para quem deseja enviar a Mensagem">
